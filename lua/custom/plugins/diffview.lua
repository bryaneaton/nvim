-- Advanced git diff and merge conflict resolution
-- Provides a comprehensive interface for reviewing git changes
-- Supports file history, merge conflicts, and branch comparisons
...
return {
  ...
  keys = {
    ...
    { '<leader>gb', '<cmd>DiffviewOpen origin/main...HEAD<cr>', desc = 'Compare branch with origin/main' },
  },
  config = function()
